// TODO create & fullfill 1xx status codes. Followed by: @see https://github.com/Siemienik/Siemply/issues/4
// TODO fullfill 2xx status codes. Followed by: @see https://github.com/Siemienik/Siemply/issues/4
export const STATUS_200_OK = 200;
export type HttpSuccessfulResponses =
    typeof STATUS_200_OK
    ;

// TODO create & fullfill 3xx status codes. Followed by: @see https://github.com/Siemienik/Siemply/issues/4
// TODO fullfill 4xx status codes. Followed by: @see https://github.com/Siemienik/Siemply/issues/4
...
// TODO fullfill 5xx status codes. Followed by: @see https://github.com/Siemienik/Siemply/issues/4
